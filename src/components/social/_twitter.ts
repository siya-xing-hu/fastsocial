...
function createTranslateTooltip(): HTMLElement {
  ...
  tooltip.innerHTML = `
    <div class="bg-theme" style="border-radius: 0.5rem; padding: 0.75rem; margin: 0.5rem 0; border: 1px solid #e5e7eb; box-shadow: 0 1px 2px 0 rgba(0, 0, 0, 0.05);">
      ...
      <span class="block whitespace-pre-wrap leading-relaxed text-sm translate-content"></span>
    </div>
  `;
